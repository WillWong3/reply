...
<body>
	...
	<DIV class=lo-box>
		<DIV class=lo-main>
			<UL id=lo-ul>
				<LI><IMG src="<%=path%>/images/lo_left.gif">
				</LI>
				<LI>
					<P class=warning>
						<LABEL id=Label1>&nbsp;</LABEL>
					</P>
					<FORM method="post" action="111" name="loginForm"
						...
						<table border="0" cellpadding="6" cellspacing="6">
							...
							<tr>
								<td style="width: 40px;font-family: 微软雅黑" align="right">
									密码：</td>
								<td align="left"><input name="userPw" type="password"
									style="width: 200px;" /></td>
							</tr>
							...
							<tr align='center'>
								...
								<td align="left">
								<input class="button button-primary button-rounded button-small" type="button" value="登陆" style="width: 100px;" onClick="check1()" />&nbsp; 
								<input class="button button-caution button-rounded button-small" type="reset" value="重置" style="width: 100px;" />&nbsp; 
								<img id="indicator" src="<%=path%>/img/loading.gif" style="display:none" /></td>
							</tr>
						</table>
