     ...
     <div class="header">
		   ...
		   <div class="main_index">
		        <div class="content dz" style="margin-top: 10px;width: 70%;height: 100%;margin-left: 210px;" >
				        ...
				        <TR>
				          <TD vAlign=top align="center" rowSpan=3>
				            <TABLE style="MARGIN-TOP: 0px" border=0>
				              ...
				              <TR>
				                  <TD align="left" width="100%" style="font-size: 12px;">
				              ...
				              <TR>
									 <c:if test="${requestScope.zhuti.user.type==1}">
										 <TD align="left" width="100%" style="font-size: 12px;">
												用户类型：老师
										</TD>

                                     </c:if>
		                            <c:if test="${requestScope.zhuti.user.type==2}">
										 <TD align="left" width="100%" style="font-size: 12px;">
												用户类型：同学
										</TD>
				        ...
				        <TR>
				          <TD vAlign=top align="center" rowSpan=3>
				            <TABLE style="MARGIN-TOP: 0px" border=0>
				              ...
				              <TR>
									 <c:if test="${huifu.user.type==1}">
										 <TD align="left" width="100%" style="font-size: 12px;">
												用户类型：老师
										</TD>

                                     </c:if>
		                            <c:if test="${huifu.user.type==2}">
										 <TD align="left" width="100%" style="font-size: 12px;">
												用户类型：同学
										</TD>
	                ...
	                <%-- <A href="#" onclick="huifuAdd(${requestScope.zhuti.id })">
		                <IMG src="<%=path %>/img/reply.gif">&nbsp;
		            </A>
		            <a class="button button-primary button-rounded button-small" style="height:32px;color:white;" href="javascript:history.back();">&nbsp;返回</a> --%>
		            
		            <button class="btn btn-warning"  onclick="huifuAdd(${requestScope.zhuti.id})" style="margin-left: 10px;color:white;font-size:12px;width:80px;"> 回复&nbsp; </button>
