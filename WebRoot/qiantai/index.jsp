									...
									<tr height="70" align="center">
										...
										<td align="left" width="600">
											<div style="font-family: 微软雅黑;font-size: 14px;">
											    <a style="color: black" href="<%=path %>/zhutiAll.action?catelogId=${cateLog.id}">${cateLog.name }</a>
											</div>
											<div style="font-family: 微软雅黑;font-size: 11px;color: #9D9D9D">${cateLog.jieshao }</div>
										</td>
										<td>
